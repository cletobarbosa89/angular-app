...
@Component({
  ...
  styleUrls: ['./creative-overview.component.css']
})
export class CreativeOverviewComponent implements OnInit {
  ...
  openDialogImage(event: any) {
    ...
    this.dialog.open(CreativeOverviewDialogImage, {
      data: {
        link: link,
      },
    });
  ...
  openDialogVideo(event: any) {
    ...
    this.dialog.open(CreativeOverviewDialogVideo, {
      data: {
        type: type,
        link: link,
      },
  ...
  openDialogGuidelines(event: any) {
    ...
    this.dialog.open(CreativeOverviewDialogGuidelines, {
      data: {
  ...
  ngOnInit(): void {
    ...
    if(this.storageService.getFromStorage('mat-select-creative-overview-campaign') && this.storageService.getFromStorage('mat-select-creative-overview-channel')) {
      this.getCreativesCount(this.creative_overview_campaigns.value?this.creative_overview_campaigns.value:'', this.creative_overview_channels.value?this.creative_overview_channels.value:'', false).then(() => {
        ...
        this.getCreatives(this.creative_overview_campaigns.value?this.creative_overview_campaigns.value:'', this.creative_overview_channels.value?this.creative_overview_channels.value:'', false, this.creativeOverviewDigitalCreativesOffset, this.creativeOverviewDigitalCreativesLimit, true);
      });
    }
  ...
  getCreatives(campaign: string, channel: string, flag: boolean, offset: number, limit: number, clear: boolean) {
    if(!flag)
      channel = "'" + channel + "'";

    this.appService.getCreatives(this.brand, campaign, channel, offset, limit).subscribe((response) => {
      if(clear) {
        this.creativeOverviewDigitalCreativeScoreData = {
          creatives: []
        };
  ...
  onScrollDown(ev: any) {
    ...
    if(this.creativeOverviewDigitalCreativesOffset <= this.creativeOverviewDigitalCreativesCount) {
      ...
      this.getCreatives(this.creative_overview_campaigns.value?this.creative_overview_campaigns.value:'', this.creative_overview_channels.value?this.creative_overview_channels.value:'', false, this.creativeOverviewDigitalCreativesOffset, this.creativeOverviewDigitalCreativesLimit, false);
...
@Component({
  selector: 'creative-overview-dialog',
  templateUrl: './creative-overview-dialog-image.html',
})
export class CreativeOverviewDialogImage {
  constructor(@Inject(MAT_DIALOG_DATA) public data: DialogData) {}
}

@Component({
  selector: 'creative-overview-dialog',
  templateUrl: './creative-overview-dialog-video.html',
})
export class CreativeOverviewDialogVideo {
  constructor(@Inject(MAT_DIALOG_DATA) public data: DialogData) {}
}

@Component({
  selector: 'creative-overview-dialog-guidelines',
  templateUrl: './creative-overview-dialog-guidelines.html',
})
export class CreativeOverviewDialogGuidelines {
