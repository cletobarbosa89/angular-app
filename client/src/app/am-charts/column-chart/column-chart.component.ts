...
export class ColumnChartComponent implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    this.browserOnly(() => {
      ...
      if(this.widgetCategory == 'brandHealthPurchaseIntent' || this.widgetCategory == 'salesLiftSLData')
      ...
      if(this.widgetData.length && (this.widgetCategory == 'brandHealthPurchaseIntent' || this.widgetCategory == 'salesLiftSLData')) {
